...
export const storyNodes: StoryNode[] = [
  {
    ...
    shots: [
      ...
      },
      {
        ...
        caption: { type: 'system', text: '아직 아무도\n기다리지 않았다.' },
      },
      {
        id: '0-1-3',
        worldLayout: 'roadWithDistantLight',
  ...
  },
  {
    ...
    interaction: {
      ...
      routeFragmentReward: { fragmentKey: 'stage0-origin-fragment' },
  ...
  },
  {
    ...
    shots: [
      ...
      { id: '1-1-3', backgroundKey: 'road', characterPose: 'hesitate', characterX: 0.5, characterY: 0.72, objects: [{ key: 'oldDoorClosed', x: 0.69, y: 0.67 }], caption: { type: 'inner', text: '익숙한 문이었다.' }, prompt: { text: '문은 대답을 기다렸다.', placement: 'object', targetX: 0.69, targetY: 0.42 } },
      {
        ...
        characterX: 0.38,
        characterY: 0.72,
        objects: [{ key: 'distantLightTiny', x: 0.86, y: 0.5 }],
        caption: { type: 'inner', text: '길은 조용했다.' },
      },
      {
        id: '1-1-2',
        worldLayout: 'oldDoorApproach',
        ...
        characterY: 0.72,
        objects: [
          { key: 'oldDoorClosed', x: 0.69, y: 0.67 },
          { key: 'distantLightTiny', x: 0.86, y: 0.5 },
        ],
        caption: { type: 'inner', text: '익숙한 문이었다.\n그래서 더 낯설었다.' },
      },
      {
        id: '1-1-3',
        worldLayout: 'oldDoorApproach',
        ...
        characterX: 0.5,
        characterY: 0.72,
        objects: [{ key: 'oldDoorClosed', x: 0.69, y: 0.67 }],
        caption: { type: 'prompt', text: '문은 대답을\n기다렸다.' },
      },
    ],
  },
  {
    ...
    interaction: {
      ...
      routeFragmentReward: { fragmentKey: 'stage1-faith-fragment' },
    ...
    shots: [
      {
        ...
        characterY: 0.72,
        objects: [
          { key: 'oldDoorOpen', x: 0.31, y: 0.67 },
          { key: 'emptyFrame', x: 0.5, y: 0.44 },
        ],
        caption: { type: 'system', text: '문이 열렸다.' },
        camera: { fade: 'in' },
      },
      {
        id: '1-4-2',
  ...
  },
  {
    ...
    shots: [
      ...
      },
      {
        ...
        characterX: 0.42,
        characterY: 0.72,
        objects: [{ key: 'glamourDoorClosed', x: 0.7, y: 0.65 }],
        caption: { type: 'inner', text: '차가웠다.\n그런데 화려했다.' },
      },
      {
        id: '2-1-3',
        worldLayout: 'glamourDoorApproach',
        ...
        characterY: 0.72,
        objects: [
          { key: 'glamourDoorClosed', x: 0.7, y: 0.65 },
          { key: 'coldCards', x: 0.58, y: 0.4 },
        ],
        caption: { type: 'prompt', text: '이름표들이\n문 앞에 쌓였다.' },
      },
    ],
  },
  {
    ...
    interaction: {
      ...
      routeFragmentReward: { fragmentKey: 'stage2-name-fragment' },
    ...
    shots: [
      {
        ...
        characterY: 0.74,
        objects: [
          { key: 'glamourDoorOpen', x: 0.28, y: 0.65 },
          { key: 'floatingPapers', x: 0.5, y: 0.42 },
        ],
        caption: { type: 'system', text: '문이 삼켰다.' },
        camera: { fade: 'in' },
      },
      {
        id: '2-4-2',
  ...
  },
  {
    ...
    interaction: {
      ...
      routeFragmentReward: { fragmentKey: 'stage3-light-fragment' },
  ...
  },
  {
    ...
    shots: [
      ...
      },
      {
        ...
        characterY: 0.72,
        objects: [{ key: 'distantLightStrong', x: 0.84, y: 0.48 }],
        caption: { type: 'system', text: '기록 조각이\n손에 남았다.' },
      },
    ],
  },
  {
